...
tellraw @s [{"text":" \u0020 "},{"text":"[DeathStop...]","color":"gray","clickEvent":{"action":"run_command","value":"/function timer:ui/ds"}}]
tellraw @s [{"text":" \u0020 "},{"text":"[Goal...]","color":"gray","clickEvent":{"action":"run_command","value":"/function timer:ui/goal"}}]
